          ...
          <x-card class="shadow-lg">
            <x-slot name="header">
              <div id="questionHeader">
                <div class="rounded-t-lg bg-tertiary px-4 py-3 text-white line-clamp-1 flex items-center justify-between gap-2">
                  ...
                  <div class="flex">
                    ...
                    <label for="hs-default-checkbox"
                      class="ms-3 text-sm">Ragu-ragu</label>
                  </div>
                </div>
              </div>
            </x-slot>
            ...
            <x-slot name="footer">
              <div class="flex items-center gap-2 rounded-b-lg border-t border-gray-200 px-4 py-3">
                <x-button type="button" id="previousQuestion" class="w-fit border-danger text-danger hover:bg-danger hover:text-white">
                ...
                <x-button type="button" id="nextQuestion" class="w-fit border-success text-success hover:bg-success hover:text-white">
                  Selanjutnya
