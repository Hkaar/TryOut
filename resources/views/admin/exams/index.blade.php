          ...
          <div class="relative flex-1">
            <div class="relative">
              <input type="text"
                ...
                name="search" placeholder="Cari sebuah ujian" value="{{ request()->has('search') ? request()->input('search') : '' }}">
              <div
      ...
      @foreach ($exams as $i => $exam)
        <tr
          ...
          <td class="flex gap-2 whitespace-nowrap px-6 py-4 text-end text-sm font-medium">
            ...
            <x-link-button to="{{ route('admin.exams.show', $exam->id) }}" class="border-info hover:bg-info hover:text-white">
