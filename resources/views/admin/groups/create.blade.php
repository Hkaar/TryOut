      ...
      <div class="flex-1 grid place-items-center">
        <div class="flex flex-col gap-3 w-full">
          <div class="flex gap-4 items-center">
            <i class="material-symbols-outlined font-var-light font-4xl">grid_view</i>

            <span class="flex flex-col gap-1">
              <h3 class="text-xl font-semibold">Tambahkan group baru</h3>
              <p class="text-gray-400">
                Tambahkan group baru di sistem anda
              </p>
            </span>
          </div>
