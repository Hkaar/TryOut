<aside id="sideBar"
  class="dark:bg-secondary_dark dark:text-black bg-white min-w-16 fixed top-0 z-20 min-h-screen -translate-x-full overflow-y-auto px-6 py-4 shadow-xl transition-all duration-300 ease-in-out md:h-auto md:min-h-screen lg:relative lg:translate-x-0 border-r border-gray-200">
    ...
    <div class="flex items-center justify-between">
      <div class="flex items-center gap-2">
        ...
        @auth
          ...
          <span class="rounded-xl bg-tertiary px-2 py-1 text-sm font-bold menu-text hidden text-white">
